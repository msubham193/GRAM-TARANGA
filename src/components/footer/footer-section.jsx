...
const FooterSection = () => {
  return (
    <div className="border-red-300 bg-gray-950 p-10 ">
      <div className="max-w-screen-xl py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto">
        ...
        <div className="p-5 sm:w-4/12">
          <h3 className="font-medium text-lg text-blue-500 mb-4">
            Subscribe to our Newsletter
          </h3>
          <form className="mt-4">
            <input
              className=" rounded w-full px-4 py-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="email"
      ...
      <div className="flex py-5 m-auto text-gray-500 text-sm flex-col items-center border-t max-w-screen-xl">
