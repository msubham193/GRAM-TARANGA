...
Command: npx gltfjsx@6.2.14 public/drone1/scene.gltf --types 
...
export function Model(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/drone1/scene.gltf");
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        ...
        >
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 6, 0]}>
...
useGLTF.preload("/drone1/scene.gltf");
